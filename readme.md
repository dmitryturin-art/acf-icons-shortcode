...
Плагин позволяет легко выводить иконки комплектации (например, для отелей, номеров, услуг) из поля ACF типа **Checkbox**. Каждая иконка отображается с всплывающей подсказкой при наведении.
...
3. Загрузите файлы `acf-icons-shortcode.php` и `readme.md` в эту папку
...
### Элемент в конструкторе WPBakery:
![Элемент в WPBakery](screenshots/wpbakery-element.png)

### Пример вывода на странице:
![Пример вывода](screenshots/frontend-example.png)

### Настройка поля ACF:
![Настройка ACF](screenshots/acf-settings.png)
